function shuffle(array) {
  ...
  function win() {
    ...
    if (s % 60 < 10) {
        stats.textContent = "你赢得了：" + stars + " 颗星，共" + movesCounter + " 次配对，用时： " + m + ":0" + s % 60;
    } else {
        stats.textContent = "你赢得了：" + stars + " 颗星，共" + movesCounter + " 次配对，用时： " + m + ":" + s % 60;
    }
  }
  ...
  function timer() {
    ...
    if (s % 60 < 10) {
        timer.textContent = "消耗时间： " + m + ":0" + s % 60;
    } else {
        timer.textContent = "消耗时间：" + m + ":" + s % 60;
    }
  ...
  function restartGame() {
    ...
    let timer = document.querySelector(".timer");
    timer.textContent = "消耗时间：0:00";
    moves.textContent = "配对次数：" + movesCounter;
